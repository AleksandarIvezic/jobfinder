...
RSpec.describe ConfirmationMailer, type: :mailer do
  before :each do
    ...
    @employer = User.create(name: 'User', email: 'user@example.com', password: 'password',
    ...
    @job_application = @job.job_applications.create(name: 'test',
                                                    birth_date: '12/12/1989',
                                                    email: 'mail@test.com',
                                                    phone: '123456789',
                                                    address: 'Test adress',
                                                    professional_qualifications: 'VSS',
                                                    resume: @file, job_id: '1')
  end
